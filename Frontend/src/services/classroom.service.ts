...
export class ClassroomService {
  ...
  getClassrooms(_id: number) {
    return this.httpClient.get<Classroom[]>(`${API_SERVER}/${RESOURCE_NAME}`)
  }

  getClassroomById(_id: number) {
    return this.httpClient.get<Classroom>(`${API_SERVER}/${RESOURCE_NAME}/${_id}`)
  }

  addClassroom(_classroom: Classroom) {
    return this.httpClient.post<Classroom>(`${API_SERVER}/${RESOURCE_NAME}`, {
      classroom: _classroom
    })
  }

  updateClassroom(_classroom: Classroom, _id: number) {
    return this.httpClient.put<Classroom>(`${API_SERVER}/${RESOURCE_NAME}/${_id}`, {
      classroom: _classroom
    })
  }
